...
RSpec.describe "formula conversion" do
  ...
  describe "variables" do
    example "<i>a</i>" do
      expect(translate).to eq("<math>a</math>")
    end
    ...
    example "<i>α</i>" do
      skip "need entity here"
      expect(translate).to eq("<math>α</math>")
    end

    example "<i>Ж</i>" do
      skip "need entity here"
      expect(translate).to eq("<math>Ж</math>")
    end
  end
  ...
  describe "basic operators" do
    ...
    example "1 &times; 2" do
      expect(translate).to eq("<math>1 xx 2</math>")
    end
